...
public class ConfigurationTest {
    ...
    public void testValues() {
        ...
        System.out.println(configuration.hideWhenMouseOutOfStage());
        System.out.println(configuration.hideWhenFixedTime());
        System.out.println(configuration.hideWhenMouseClickOutside());
